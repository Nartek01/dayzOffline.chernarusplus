...
void ExpInit_DefaultPatrolsSettings(out ExpAIGroups Data)
{
    ...
    switch (worldName)
    {
        ...
        case "chernarusplus": //Tested Good Points and Loadouts. Waypoint Behavior specific to the waypoints, not all behaviors will work correctly with some routes
            ...
            Data.Group.Insert( new ExpAIGroup(1,	"WALK",     "LOOP",    	"WEST",     	"", -2, 1, -2,      	"3903.399902 27.919600 2922.250000",    {"3904.149902 27.757799 2926.810059", "3904.209961 27.756001 2930.050049","3902.219971 28.032499 2913.830078"} ));
        break;
        case "chiemsee":
